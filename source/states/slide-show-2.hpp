...
class Slide2 : public our::State
{
    ...
    void onInitialize() override
    {
        ...
        menuMaterial->texture = our::texture_utils::loadImage("assets/textures/2.png");
        ...
        buttons[0].position = {510.0f, 18.0f};
        buttons[0].size = {260.0f, 37.0f};
        buttons[0].action = [this]()
        { this->getApp()->changeState("3"); };
    }
