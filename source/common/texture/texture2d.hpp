...
namespace our
{
    ...
    // This class defines an OpenGL texture which will be used as a GL_TEXTURE_2D
    class Texture2D
    {
    ...
    public:
        ...
        Texture2D()
        {
            ...
            // Generate a texture object and store its name
            glGenTextures(1, &name);
        };

        // This destructor deletes the underlying OpenGL texture
        ~Texture2D()
        {
            // TODO: (Req 5) Complete this function
