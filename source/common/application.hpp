        ...
        void changeState(std::string name)
        {
            ...
            if (it != states.end())
            {
                if (name == "play")
                {
                    ...
                    SoundEngine->play2D("assets/sounds/space.mp3", true);
                }
                else if (name == "menu")
                {
                    SoundEngine->stopAllSounds();
                    SoundEngine->play2D("assets/sounds/menu.mp3", true);
                }
                else if (name == "lose")
                {
                    SoundEngine->stopAllSounds();
                    SoundEngine->play2D("assets/sounds/lose.mp3", false);
                }
                else if (name == "win")
                {
                    SoundEngine->stopAllSounds();
                    SoundEngine->play2D("assets/sounds/win.mp3", false);
                }
                nextState = it->second;
            }
        }
